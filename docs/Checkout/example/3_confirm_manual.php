 ...
 * (Run 1_start_checkout.php first to create a transaction.)
 */
...
// Load the transaction ID created by 1_start_checkout.php (or pass it as an argument).
try {
...
try {
    ...
    // processed transactions will be rejected by the portal.
    echo "\n[FAILED] " . $e->getMessage() . "\n";
