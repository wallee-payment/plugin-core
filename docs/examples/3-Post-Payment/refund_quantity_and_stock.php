 ...
 *   php ../../Checkout/example/3_start_checkout.php
 *   php ../../Checkout/example/4_modify_cart.php   (bumps the Swiss Watch to qty 2)
 *   php ../../Checkout/example/5_confirm_manual.php
...
//
// See docs/3-Post-Payment/Invoice.md for the full Invoice documentation.
...
if ($targetItem === null) {
    exit(
        ...
        "Run 4_modify_cart.php (which sets the Swiss Watch to qty 2) before capturing, then try again.\n"
    );
}
